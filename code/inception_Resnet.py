...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 27 00:28:28 2022
...
class Stem(nn.Module):
    def __init__(self, in_channels):
        ...
        self.branch_1 = nn.Sequential(
            ...
            Conv2d(48, 64, 5, stride=1, padding=2, bias=False), # 确保最后都为35*35大小，因此需要padding
        )
...
class Inception_ResNetv2(nn.Module):
    def __init__(self, in_channels=1, classes=24, k=256, l=256, m=384, n=384):
